...
- [x] 1. Database migration and schema setup
  - [x] 1.1 Create database migration file for all Phase 1 tables
...
- [x] 2. Backend types, errors, and validation schemas
  - [x] 2.1 Create `fixed-assets.types.ts` with all TypeScript interfaces and DTOs
  ...
  - [x] 2.2 Create `fixed-assets.errors.ts` with custom error classes
  ...
  - [x] 2.3 Create `fixed-assets.schema.ts` with Zod validation schemas
...
- [x] 3. Repository layer (database queries)
  - [x] 3.1 Create `fixed-assets.repository.ts` with all CRUD operations
...
- [x] 4. Core service (categories CRUD, asset CRUD, code generator)
  - [x] 4.1 Create `asset-code-generator.util.ts` for asset code generation
  ...
  - [x] 4.2 Create `fixed-assets.service.ts` with core business logic
...
- [x] 5. Depreciation service
  - [x] 5.1 Create `depreciation.service.ts` with calculation and batch run logic
...
- [x] 6. Asset lifecycle service (capitalization, transfer, maintenance, disposal)
  - [x] 6.1 Create `asset-lifecycle.service.ts` with lifecycle operations
...
- [x] 7. QR code utility
  - [x] 7.1 Create `qr-code.util.ts` for QR code generation
...
- [x] 8. Controller and routes
  - [x] 8.1 Create `fixed-assets.controller.ts` with HTTP request handlers
  ...
  - [x] 8.2 Create `fixed-assets.routes.ts` with Express router setup
  ...
  - [x] 8.3 Register fixed-assets routes in `backend/src/app.ts`
...
- [x] 10. Integration hooks with GR and PI modules
  - [x] 10.1 Add asset creation hook in Goods Receipt confirmation
  ...
  - [x] 10.2 Add capitalization hook in Purchase Invoice posting
...
- [x] 12. Frontend: API service and types
  - [x] 12.1 Create `frontend/src/features/fixed-assets/api/fixed-assets.api.ts`
  ...
  - [x] 12.2 Create `frontend/src/features/fixed-assets/types/fixed-asset.types.ts`
    - Define frontend TypeScript types mirroring backend interfaces
    - _Requirements: 1.1_

  - [x] 12.3 Create `frontend/src/features/fixed-assets/utils/fixedAssetFilters.url.ts`
...
- [x] 13. Frontend: Asset Categories page
  - [x] 13.1 Create `AssetCategoriesPage.tsx` with CRUD table
...
- [x] 14. Frontend: Fixed Assets list and detail pages
  - [x] 14.1 Create `FixedAssetsPage.tsx` with paginated, filterable asset list
  ...
  - [x] 14.2 Create `FixedAssetDetailPage.tsx` with asset info and movement timeline
...
- [x] 15. Frontend: Asset Request page
  - [x] 15.1 Create `AssetRequestPage.tsx` for asset purchase requests
...
- [x] 16. Frontend: Depreciation Run page
  - [x] 16.1 Create `DepreciationRunPage.tsx` with preview and confirm workflow
...
- [x] 17. Frontend: Transfer, Maintenance, and Disposal pages
  - [x] 17.1 Create `AssetTransfersPage.tsx` with transfer list and create form
  ...
  - [x] 17.2 Create `AssetMaintenancePage.tsx` with maintenance list and actions
  ...
  - [x] 17.3 Create `AssetDisposalsPage.tsx` with disposal list and create/post workflow
...
- [x] 18. Frontend: Menu, routing, and permission registration
  - [x] 18.1 Register routes in `App.tsx` and sidebar menu configuration
...
- [x] 19. Permission seeding and default category data
  - [x] 19.1 Create seed script for fixed_assets permissions and default categories
...
- [ ] 20. Data migration from Supabase (1200 existing asset records)
  - [x] 20.1 Create migration script to download photos from Supabase Storage and upload to S3
  ...
  - [x] 20.2 Create data migration script from Supabase asset table to fixed_assets
