...
export const UpdateEmployeeSchema = CreateEmployeeSchema.omit({ employee_id: true, user_id: true }).partial()
...
export const EmployeeSearchSchema = z.object({ q: z.string().optional() })
