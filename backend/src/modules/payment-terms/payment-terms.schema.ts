...
export const createPaymentTermSchema = z.object({
  body: z.object({
    ...
    payment_dates: z.array(z.number().int().min(1).max(31)).optional(),
    payment_day_of_week: z.number().int().min(1).max(7).optional(),
    ...
    maximum_order_amount: z.number().min(0).optional(),
