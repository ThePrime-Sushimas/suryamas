...
export class EmployeeBranchesService {
  private toDto(entity: EmployeeBranchWithRelations): EmployeeBranchDto {
    return {
      ...
      position_code: entity.position?.position_code || null,
      position_name: entity.position?.position_name || null,
      department_name: entity.position?.department_name || null,
  ...
  async getMyBranches(userId: string): Promise<MyBranchDto[]> {
    ...
    return data
      ...
      .map(item => ({
        ...
        position_name: item.position?.position_name || null,
        department_name: item.position?.department_name || null,
