...
import menuCategoriesRoutes from "./modules/food-production/menu-categories/menu-categories.routes";
import menuGroupsRoutes from "./modules/food-production/menu-groups/menu-groups.routes";
...
import theoreticalConsumptionRoutes from "./modules/food-production/theoretical-consumption/theoretical-consumption.routes";
...
import productionRequestsRoutes from './modules/production-requests/production-requests.routes';
...
import fixedAssetsRoutes from './modules/fixed-assets/fixed-assets.routes';
...
app.get("/health", async (req, res) => {
  try {
    ...
    res.json({ status: "OK", db: "connected", db_time: rows[0].db_time, timestamp: new Date().toISOString() });
  } catch (err: any) {
...
app.use("/api/v1/theoretical-consumption", theoreticalConsumptionRoutes);
...
app.use('/api/v1/production-requests', productionRequestsRoutes);
