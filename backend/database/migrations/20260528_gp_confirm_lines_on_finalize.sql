-- Backfill: GP header CONFIRMED but input lines still DONE (blocks PI journal posting)
UPDATE goods_processing_inputs gpi
SET status = 'CONFIRMED',
    qc_confirmed_by = gp.qc_confirmed_by,
...
-- Unconfirm must also revert CONFIRMED lines (not only DONE)
