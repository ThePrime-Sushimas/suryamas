    ...
    <div className="flex flex-wrap gap-3 mb-5">
      {summary.pending_count > 0 && (
        <div className="flex items-center gap-2 px-3 py-2 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg text-xs text-amber-700 dark:text-amber-400">
          ...
          <span><strong>{summary.pending_count}</strong> transaksi hari ini — masuk: {fmt(summary.pending_income_estimate)}{summary.pending_expense_estimate > 0 ? ` · keluar: ${fmt(summary.pending_expense_estimate)}` : ''}</span>
        </div>
      )}
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 dark:bg-gray-900 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">In-Out</h1>
