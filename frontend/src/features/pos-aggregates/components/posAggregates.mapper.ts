...
export function mapFormToCreateDto(
  ...
  return {
    ...
    other_vat_amount: form.other_vat_amount,
    bill_after_discount: form.bill_after_discount,
    rounding_amount: form.rounding_amount,
    delivery_cost: form.delivery_cost,
    order_fee: form.order_fee,
    promotion_discount_amount: form.promotion_discount_amount,
    voucher_discount_amount: form.voucher_discount_amount,
