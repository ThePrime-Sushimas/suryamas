...
export const BankForm = ({ initialData, onSubmit, isLoading }: BankFormProps) => {
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
      <div>
        <label htmlFor="bank_code" className={labelCls}>Kode Bank <span className="text-red-500">*</span></label>
      ...
      <div>
        <label htmlFor="bank_name" className={labelCls}>Nama Bank <span className="text-red-500">*</span></label>
        <input id="bank_name" type="text" {...form.register('bank_name')} className={inputCls} placeholder="cth: Bank Central Asia" />
      ...
      <div className="flex items-center">
        ...
        <label htmlFor="is_active" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">Aktif</label>
      </div>
