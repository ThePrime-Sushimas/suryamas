        ...
        <table className="min-w-full border-collapse">
            ...
            {preview.vouchers.map((voucher: VoucherDay) => {
              ...
              return (
                <React.Fragment key={voucher.transaction_date}>
                  {/* Day header row */}
                  <tr
                    className="bg-white dark:bg-gray-800 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-all border-l-4 border-l-transparent hover:border-l-blue-500"
                  ...
                  >
                    ...
                    <td className="px-3 py-4">
                      <span className="text-xs text-gray-400 dark:text-gray-500 italic">Multi-acc</span>
                    </td>
                  ...
                  {isExpanded && (
                    <tr>
                      <td colSpan={7} className="px-6 py-0 bg-gray-50/50 dark:bg-gray-900/20">
                        <div className="py-4 space-y-3">
                          ...
                          <div className="flex items-center justify-between px-2">
                            ...
                            {/* Phase 2: Tombol confirm akan diaktifkan setelah backend ready */}
                            <div className="flex items-center gap-2">
                              <span className="text-[10px] text-gray-400 dark:text-gray-500 italic">
                                Konfirmasi tersedia di Phase 2
                              </span>
                            </div>
                          </div>
                          ...
                          <table className="min-w-full divide-y divide-gray-100 dark:divide-gray-800">
                                ...
                                >
                                  ...
                                  <td className="px-2 py-2">
                                    <div className="flex items-center gap-1.5">
                                      <span className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${line.is_fee_line ? 'bg-red-400' : 'bg-green-400'}`} />
                            ...
                            <tfoot className="border-t border-gray-200 dark:border-gray-700 text-[10px] font-bold text-gray-500 dark:text-gray-400">
                              <tr>
                                <td colSpan={2} className="px-2 py-1.5 text-right uppercase tracking-wide">
                                  Subtotal
                                </td>
          ...
          <tfoot className="bg-gray-50 dark:bg-gray-900 border-t-2 border-gray-200 dark:border-gray-700">
            <tr className="font-bold text-gray-900 dark:text-gray-100">
              <td colSpan={4} className="px-3 py-4 text-right uppercase text-xs tracking-wider text-gray-400">
                Total Periode
              </td>
