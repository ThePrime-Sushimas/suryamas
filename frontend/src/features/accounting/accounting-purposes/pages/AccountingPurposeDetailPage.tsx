    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-4">Tujuan akuntansi tidak ditemukan</p>
          <button
            onClick={onBack}
        ...
        <div className="flex gap-3">
          {purpose.is_deleted && onRestore ? (
            ...
            <button
              ...
              title={!canModify ? 'Purpose sistem tidak bisa diedit' : ''}
            >
              <Edit size={16} />
              Edit
            </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Detail Purpose</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            {!purpose.is_system && (
              <span className="text-sm text-gray-500 dark:text-gray-400 mt-2 block">Purpose Kustom</span>
            )}
          </div>

          {/* Metadata */}
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Informasi</h3>
