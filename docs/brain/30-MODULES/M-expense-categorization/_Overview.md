...
backend_path: backend/src/modules/expense-categorization
api_base: /api/v1/expense-categorization
permission_module: expense-categorization
depends_on:
