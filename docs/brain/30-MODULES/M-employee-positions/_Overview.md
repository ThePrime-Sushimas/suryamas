---
type: module
slug: employee-positions
status: active
domain: "[[20-DOMAINS/HR/_Index|HR]]"
backend_path: backend/src/modules/employee-positions
api_base: /api/v1/employee-positions
permission_module: employee-positions
depends_on:
