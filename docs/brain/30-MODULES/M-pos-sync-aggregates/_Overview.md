---
type: module
slug: pos-sync-aggregates
status: active
domain: "[[20-DOMAINS/Sales-POS/_Index|Sales-POS]]"
backend_path: backend/src/modules/pos-sync-aggregates
api_base: /api/v1/pos-sync-aggregates
permission_module: pos-sync-aggregates
depends_on:
